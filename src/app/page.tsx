  ...
  return (
    <main className="flex h-[calc(100dvh)] flex-col items-center justify-center p-4 md:px-24 py-32 gap-4">
      <div className="flex justify-between max-w-5xl w-full items-center">
        <Link href="#" className="text-4xl font-bold text-gradient">Zap Zap 2</Link>
        <Link
          href="https://github.com/henriquemattia"
          className={cn(
      ...
      <p className="max-w-[150px] sm:max-w-lg">Built by <a className="font-semibold" href="https://github.com/henriquemattia">Henrique Mattia</a>. To be used with <a className="font-semibold" href="https://ui.shadcn.com/">shadcn</a>.</p>
